...
export function Login() {
    ...
    const [emergencyContactInformation, setEmergencyContactInformation] = useState<any>(null);
    ...
    const sendUserData = (token: string) => {
       ...
       console.log(parsedData)
        ...
        .catch(error => console.error('Error sending personal information:', error));
        ...
        .then(response => response.json())
        .then(data => console.log("Emergency Contact Information Response:", data))
        .catch(error => console.error('Error sending emergency contact information:', error));
        ...
        .catch(error => console.error('Error sending doctor information:', error));
        ...
        .catch(error => console.error('Error sending test information:', error));
    };
